                ...
                <div className="row mb-5">
                    ...
                    <div id="leftDiv" className="bg-secondary pt-2">
                      <form onSubmit={handleSubmit(onSubmit)}>                
                        ...
                        <div className="m-3">
                            <input type="email" className="form-control" name="email" {...register("email", { required: true })} value={loggedInUser.email}/>
                        ...
                        <div className="m-3">
                            <input type="text" className="form-control" name="title" {...register("title", { required: true })} value={courseInfo.title} />
                            {errors.title && <span> Title is required</span>}
                        </div>
                        <div className="m-3">
                            <input type="text" className="form-control" name="price" {...register("price", { required: true })} value={courseInfo.price} />
